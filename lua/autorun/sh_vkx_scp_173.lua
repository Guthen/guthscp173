...
local message = "[IMPORTANT] You are using an old version of Guthen's SCP 173 addon, please consider upgrading to the new version. You can find the new addons in this collection: https://steamcommunity.com/sharedfiles/filedetails/?id=3034749707"
MsgC( Color( 255, 0, 0 ), message, "\n" )
if CLIENT then 
    hook.Add( "InitPostEntity", "GuthSCP:NewSCP173Version", function()
